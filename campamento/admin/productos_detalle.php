...
<html>
    ...
    <body>
        ...
        <form  name="formato" id="formato">
            <div id="contenedor">
                <img id="im" src="img/productos/<?php echo"$archivo_nn"; ?>" height="200" width="200">
                <h5 align="center" ><?php echo"$archivo"; ?></h5> <br>
                
                <label align="center" >Nombre:  <?php echo" $nombre ";?></label> <br><br>
                <label align="center" >Descripcion:  <?php echo" $descripcion ";?></label> <br><br>

                <label align="center" >Costo:     <?php echo"$costo"; ?> </label><br><br>
                <label align="center" >Stock:     <?php echo"$stock"; ?> </label><br><br>
